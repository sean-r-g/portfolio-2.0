    ...
    <div class="bio-container" id="bio">
      <div class="bio-section" id='background'>
        <article class="bio-article">
          <h3>Background</h3>
          <p>Welcome! I'm Sean Gillis, an asipring software engineer with over five years experience working in the tech industry. I've spent the past several years leading teams of developers, data engineers, and analysts as a project manager -- and now I want be a part of those very teams.</p>
